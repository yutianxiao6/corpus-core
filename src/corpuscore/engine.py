...
from corpuscore.concurrency import AsyncMicroBatcher, QueuedEmbeddingProvider, QueuedReranker
from corpuscore.config.models import CorpusConfig, OrganizerConfig, RerankerConfig, RetrievalProfile
from corpuscore.contracts.common import JSONValue
from corpuscore.contracts.indexing import IngestionReport
...
from corpuscore.embeddings import (
    HashedLexicalSparseEmbedding,
    QwenSentenceTransformerEmbedding,
)
from corpuscore.exceptions import ConfigurationError, LocalResourceMissingError, RerankerError
from corpuscore.indexing import IngestionJournal
from corpuscore.ingestion import IngestionService, PreviewReport, build_index_specification
...
from corpuscore.ports import Reranker, ResultOrganizer, RetrievalStrategy
...
from corpuscore.vectorstores import QdrantLocalVectorStore, QdrantServerVectorStore
...
class RetrievalEngine:
    ...
    @classmethod
    def from_config(cls, config: CorpusConfig) -> RetrievalEngine:
        return cls(config)

    @classmethod
    def from_yaml(cls, path: str | Path) -> RetrievalEngine:
        """Create an engine directly from a versioned CorpusCore YAML file."""
    ...
    def _rerank(
        ...
        if profile.reranker:
            ...
            except (LocalResourceMissingError, RerankerError):
