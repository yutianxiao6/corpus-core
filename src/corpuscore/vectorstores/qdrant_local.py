...
from corpuscore.backup import create_local_backup
...
from corpuscore.contracts.retrieval import SearchHit, SearchRequest, SearchVector
            ...
            try:
                if not self._client.collection_exists(self._collection_name):
                    ...
                    self._client.create_collection(
                        ...
                        metadata={
                            "corpuscore_index_fingerprint": fingerprint,
                ...
                actual = metadata.get("corpuscore_index_fingerprint")
